...
public class PostResourceAllocationAction
    ...
    protected Optional<Message> performWithResponse(State from, State to, Event event,
        ...
        String direction = flow.isForward(flowMirrorPath.getFlowMirrorPoints().getFlowPath()) ? "forward" : "reverse";
        FlowMirrorPointResponse response = FlowMirrorPointResponse.builder()
                ...
                .mirrorPointSwitchId(flowMirrorPath.getSrcSwitchId())
                .receiverPointSwitchId(flowMirrorPath.getDestSwitchId())
                .receiverPointPort(flowMirrorPath.getDestPort())
                .receiverPointVlan(flowMirrorPath.getDestVlan())
                .build();
