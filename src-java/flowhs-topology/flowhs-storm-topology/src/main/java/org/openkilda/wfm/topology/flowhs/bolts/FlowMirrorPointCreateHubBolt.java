...
public class FlowMirrorPointCreateHubBolt extends HubBolt implements FlowMirrorPointCreateHubCarrier {
    ...
    protected void onRequest(Tuple input) throws PipelineException {
        ...
        if (payload instanceof FlowMirrorPointCreateRequest) {
            FlowMirrorPointCreateRequest flowRequest = (FlowMirrorPointCreateRequest) payload;
            service.handleCreateMirrorPointRequest(currentKey, pullContext(input), flowRequest);
        } else {
