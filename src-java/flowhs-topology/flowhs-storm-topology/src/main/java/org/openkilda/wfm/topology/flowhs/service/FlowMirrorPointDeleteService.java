...
public class FlowMirrorPointDeleteService {
    ...
    public FlowMirrorPointDeleteService(FlowMirrorPointCreateHubCarrier carrier, PersistenceManager persistenceManager,
    ...
    /**
     * Handles request for flow create mirror point.
     *
