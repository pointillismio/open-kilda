...
public class OnFinishedWithErrorAction
        extends AnonymousAction<FlowMirrorPointDeleteFsm, State, Event, FlowMirrorPointDeleteContext> {
    ...
    @Override
    public void execute(State from, State to, Event event, FlowMirrorPointDeleteContext context,
